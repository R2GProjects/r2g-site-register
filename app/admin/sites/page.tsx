              ...
              {items.map(s => (
                <tr key={s.Id as number}>
                  ...
                  <td style={{ display: "flex", gap: 4 }}>
                    ...
                    <button className="btn btn-secondary" style={{ minHeight: 32, padding: "4px 12px", fontSize: "0.75rem" }} onClick={() => window.location.assign(`/admin/prestart?siteId=${s.Id}`)}>Pre-start</button>
                    <button className="btn btn-secondary" style={{ minHeight: 32, padding: "4px 12px", fontSize: "0.75rem" }} onClick={() => window.location.assign(`/admin/documents?siteId=${s.Id}`)}>Documents</button>
